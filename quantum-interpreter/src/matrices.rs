...
pub static I: Lazy<Arc<Matrix>> = Lazy::new(|| Arc::new(Matrix::eye(2)));
pub static SWAP: Lazy<Arc<Matrix>> = Lazy::new(|| {
    Arc::new(array![
        [*_1, *_0, *_0, *_0],
        [*_0, *_0, *_1, *_0],
        [*_0, *_1, *_0, *_0],
...
pub static H: Lazy<Arc<Matrix>> = Lazy::new(|| {
    let s = Complex64::from(std::f64::consts::FRAC_1_SQRT_2);
    Arc::new(array![[s, s], [s, -s]])
});
pub static CNOT: Lazy<Arc<Matrix>> = Lazy::new(|| {
    Arc::new(array![
        [*_1, *_0, *_0, *_0],
        [*_0, *_1, *_0, *_0],
        [*_0, *_0, *_0, *_1],
