...
class AboutIteration < EdgeCase::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    assert_equal (2..6).step(2).to_a, more_even_numbers
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # It's just reduce/fold (not sure if left or right, though)
  end
  ...
  #   # code to read 'file'
  #   Because we'd have to close it otherwise, and there could be hairy
  #   exceptions, etc. Better to have it closed for us.
  #
